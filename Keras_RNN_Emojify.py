...
# LSTM model (taking word ordering into account)
# Embedding Layer: Use WE to represent words
# Use a first layer with LSTM units for each input word (connected among them)
# Use Dropout for regularization
# Use a second layer with LST units for each input word (connected among them)
# Dropout and Softmax at the end (last LST unit)
