...
def __init__():
    # Loading the dataset
    X_train_orig, Y_train_orig, X_test_orig, Y_test_orig, classes = utils.load_dataset('dataset/signs/test_signs.h5',
                                                                                       'dataset/signs/train_signs.h5')
    ...
    # PREDICTION
    # my_image = "dataset/signs/thumbs_up.png"
    #
    # # Preprocess your image to fit your algorithm.
    # f_name = my_image
    # image = np.array(ndimage.imread(f_name, flatten=False))
    # my_image = scipy.misc.imresize(image, size=(64, 64)).reshape((1, 64 * 64 * 3)).T
    # my_image_prediction = utils.predict(my_image, parameters)
    #
    # # plt.imshow(image)
